...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  'packages/bundle/hscoach': { kind: 'none', reason: 'The profile runs no harness agent and logs no session; the coach\'s own direct DeepSeek-compatible calls never enter model requests or Session events.' },
